...
/**
 * @param ref       Target branch of the pull request (`base.ref`).
 * @param psVersion PrestaShop version detected on the PR head, e.g. `9.2.0`. Only consulted
 *                  when the ref is not a release branch.
 * @returns the branch key, or UNKNOWN_BRANCH_KEY when it cannot be derived.
 */
export function branchKeyFromRef(ref: string | null | undefined, psVersion?: string | null): string {
...
/** @param version e.g. `9.2.0`, `1.7.8.11` */
export function parsePsVersion(version: string | null | undefined): { major: number; minor: number } | null {
